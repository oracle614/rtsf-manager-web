    ...
    <div>
        <div>
          ...
          <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="responsible" label="作者"/>
            <el-table-column prop="tester" label="执行人"/>
            <el-table-column prop="case_type" label="类型"/>
            <el-table-column prop="func" label="调用名"/>
            ...
            <el-table-column label="操作">
                <template slot-scope="scope">
                  ...
                  <el-button size="mini" type="danger" @click="delete_ui_case(scope.$index, scope.row)">删除</el-button>
                </template>
            </el-table-column>
          </el-table>
        </div>
        ...
        <el-dialog :title="dialog_config.title" :visible.sync="dialog_config.edit_dialog_form_visible">
          <el-form :label-position="dialog_config.label_position" label-width="80px" :model="case" :rules="rule" ref="case_form">
            <el-form-item label="用例" prop="name">
              <el-input v-model="case.name"/>
            </el-form-item>
            <el-form-item label="描述" prop="module">
              <el-input v-model="case.module"/>
            </el-form-item>
            <el-form-item label="备注">
              <el-input v-model="case.comment"/>
            </el-form-item>
          </el-form>
          <div slot="footer">
      ...
      methods: {
          ...
          submit_form: function() {
            this.$refs['case_form'].validate((valid) => {
              if (valid) {
                if(typeof(this.case.id) == "undefined") {
          ...
          delete_ui_case: function(index, row) {
